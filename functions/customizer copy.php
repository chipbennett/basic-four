...
/*
	...
	// page wrap color
	$wp_customize->add_setting( 'cram_options[page_wrap_color]', array(
	    'default' => '',
	    'type' => 'option',
	    'sanitize_callback'    => 'sanitize_hex_color_no_hash',
	    'sanitize_js_callback' => 'maybe_hash_hex_color',
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'cram_options[page_wrap_color]', array(
	    'label'   => 'Page Wrap Color',
	    'section' => 'colors',
	) ) );
